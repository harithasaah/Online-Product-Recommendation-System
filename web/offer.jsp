...
int cuid=Integer.parseInt(cid);
 ...
 ArrayList alls=new ArrayList();                       
     ...
     ResultSet res=st.executeQuery("select * from cdetails where user_id='"+cuid+"' and amt>=500000 and cunt>=10");
     while(res.next())
                 {
         flg=1;
         break;
      ...
      if(flg==1)                  
                   {
          out.println("<h1>10 % OFFER FOR ALL...</h1>");
                           ...
                           if (Db_connection.con != null) {
                               try {
                                   ...
                                   ResultSet rst=stmt.executeQuery("select items from promise_trans where user_id='"+cuid+"'");
                                   while(rst.next())
                                         {
                                            String itm=rst.getString("items");
                                            afitm=afitm+itm;
                                         }
                                   String[] aftm=afitm.split("(?!^)");
                                   for(int w=0;w<aftm.length;w++)
                                                                             {
                                       String alft=aftm[w];
                                       alls.add(alft);
                                                                             }
                                   ...
                                   while (resultset.next()) {
                                       itname = resultset.getString(1);
                                           ...
                                           if(alls.contains(itname))
                                                                                             {
                                                                                             }
                                           else
                                                                                             {
                                                if ((itname.compareTo("K") == 0) || (itname.compareTo("L") == 0) || (itname.compareTo("N") == 0) || (itname.compareTo("O") == 0) || (itname.compareTo("P") == 0) || (itname.compareTo("Q") == 0) || (itname.compareTo("R") == 0) || (itname.compareTo("Y") == 0) || (itname.compareTo("Z") == 0) || (itname.compareTo("w") == 0)) {
                                           id[i] = itname;
