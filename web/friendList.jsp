...
onpageshow="if (event.persisted) noBack();" onUnload="">
    ...
    <table> <tr><td>
       <img src="images/index.jpg" width="450" height="350">
            ...
            <table>
                <form action="friendList.jsp" method="get" >
                ...
                <%   boolean flag = false;
                  try      {
                                       if(request.getParameter("email_id")!= null||request.getParameter("eamil_id")!= "" )
                                                  {
                                                   String  mail_id = request.getParameter("email_id").trim();

                                                    String item="";
                                                    ResultSet rs = null;
                                                    String query1= "SELECT  item FROM wishlist WHERE  mail_id = '"+mail_id+"' and isValid=1 ";
                                                    ...
                                                    out.println("<tr> <td><input type=\"hidden\" name=\"item\" value=\""+rs.getString(1)+"\"><input type=\"image\" src=\""+rs.getString(5)+"\" height=\"100\" width=\"100\"> </td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            </td>");
                                                    out.println("<td><font size=\"1\"> <p>"+rs.getString(3)+"<br>Price:"+rs.getString(4)+"</p></font></td></form>");
                                                    out.println("</td></tr>" );
                                                    //out.println(""<td><form action=\"remove.jsp\" method =\"post\"><input type=\"hidden\" name =\"ITEM\" value=\""+rs.getString(1)+"\"");
                                                    ...
                                                    //rset.close();
                                                    query1="";
                                             }  if(flag==false && (request.getParameter("email_id")!= null||request.getParameter("eamil_id")!= "" )) {
                                                          out.println("No Matching Found Or No Items In List");
