        ...
        <h4>IF Item Support > Min_support(60%)</h4><br>
           ...
           <h4>cost = inter cluster similarity + intra_cluster_dissimilarity  </h4><br>
            ...
            <h4><font color="blue"> IF Item Support Count > min_sup(DB)<br>
               Then <br>
               Item to be a Frequent Item .<br></br ><br>


               IF (Item Support Count >= min_PL   and Item Support Count < min_sup(DB)) <br> <br>
               Then <br>
               Item to be a Promise Frequent Item . <br></font> <br> </h4>
