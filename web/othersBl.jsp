...
<body>
	...
	<div id="header-wrap"><div id="header-content">
   	...
   	<!-- Menu Tabs -->
<ul>
			<li><a href="indexBl.jsp" id="current">Home</a></li>
            ...
            if(Db_connection.con!=null)
            {
                 try{
                        ...
                        while(resultset.next())
                        {
                            ...
                            if((itname.compareTo("A")==0) || (itname.compareTo("C")==0) || (itname.compareTo("B")==0) ||(itname.compareTo("F")==0) ||(itname.compareTo("G")==0) || (itname.compareTo("J")==0) || (itname.compareTo("T")==0) || (itname.compareTo("U")==0) || (itname.compareTo("i")==0)||(itname.compareTo("v")==0) || (itname.compareTo("x")==0))
                            {
                            id[i]=itname;
