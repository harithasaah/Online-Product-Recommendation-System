...
<body>
            ...
            if(Db_connection.con!=null)
            {
                 try{
                        ...
                        while(resultset.next())
                        {
                            ...
                            if((itname.compareTo("E")==0) || (itname.compareTo("D")==0) || (itname.compareTo("H")==0) ||(itname.compareTo("I")==0) ||(itname.compareTo("M")==0) || (itname.compareTo("S")==0)||(itname.compareTo("V")==0) || (itname.compareTo("W")==0) || (itname.compareTo("X")==0))
                              {   
                                id[i]=itname;
                        ...
                        <tr><form action="#" method="get">
                            ...
                            <form action="#" method="post">
                              ...
                              <% if(id[j+2]!=null)
                                 {%>
                            <form action="#" method="post">
                            <td><input type="hidden" name="item" value="<%= id[j+2]%>" ><a href="prodBl.jsp"><font size="2" color="blue"><%= n[j+2] %></font></a></td>
                            </form><%}%>
                        </tr>
  ...
  <tr>
	...
	<div id="sidebar">
            ...
            <ul class="sidemenu"><li><p>You Have Account?<br> Then, Login to Trade0nE ACCOUNT</p></li>
