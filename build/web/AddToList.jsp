            ...
            if(Db_connection.con!=null)
            {
                 try{
                        ...
                        while(resultset.next())
                        {
                            ...
                            {
                        %>
                                <form action="add2list" method="post">
                                ...
                                <tr><td><p align="center"><input type="hidden" name="Buttonname" value="<%= itemid%>"><input type="image" src="images/list.jpg" onmouseover="this.src='images/listover.jpg';" onmouseout="this.src='images/list.jpg';"></p></td></tr></form>
