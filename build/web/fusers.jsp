...
<body >
	...
	<table>
	<tr><th>Frequent Users</th><th><a href="uusers.jsp">Utility Users</a></th>
...
ResultSet rs=st.executeQuery("select * from cdetails where cunt>=10");
%>
<table align="center">
    <tr>
        <th>User_Id</th><th>User_Name</th><th>Email-Id</th><th>Count</th>
    </tr>
<%
while(rs.next())
       { 
    %>
    <tr><td><%=rs.getInt("user_id")%> </td><td><%=rs.getString("user_name") %></td><td><%=rs.getString("email")%></td><td><%=rs.getInt("cunt") %></td></tr>
<%}
